...
public class MessagesViewImpl extends PopupViewImpl<MessagesPresenter> implements MessagesView {
	...
	public void show() {
		...
		//Deferring the appearance ensures all DOM modifications have finished before the animation.
	...
	protected String getContentForHtmlPanel(ScreenTemplates templates) {
		return templates.getTemplateFor(ScreenTemplates.TemplateNames.messages);
	}
}
