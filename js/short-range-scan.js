...
var ShortRangeScan={
		...
		update:function(quadrant){
			...
			ShortRangeScan.updateList("&nbsp;*&nbsp;",quadrant.stars, function(star){return "";});
			...
			ShortRangeScan.updateList("&lt;!&gt;",quadrant.starbases, function(starbase){return "";});
			if (StarShip.quadrant === quadrant)
				ShortRangeScan.updateList("O=Ξ",[StarShip],function(starhip){return "";});
